                                  ...
                                  bool target_aa64)
{
    ...
    trace_arm_set_cpu_on(cpuid, target_el,
                         target_aa64 ? "aarch64" : "aarch32", entry,
                         context_id);
...
int arm_set_cpu_on_and_reset(uint64_t cpuid)
{
    ...
    trace_arm_set_cpu_on_and_reset(cpuid);
