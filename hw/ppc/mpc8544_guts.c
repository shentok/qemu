...
REG32(GUTS_PORPLLSR, 0x00)
    FIELD(GUTS_PORPLLSR, E500_RATIO, 16, 6)
                                  ...
                                  unsigned size)
{
    ...
    case MPC8544_GUTS_ADDR_PORPLLSR:
        value = FIELD_DP32(value, GUTS_PORPLLSR, E500_RATIO, 3);
        value = FIELD_DP32(value, GUTS_PORPLLSR, DDR_RATIO, 7);
        value = FIELD_DP32(value, GUTS_PORPLLSR, PLAT_RATIO, 4);
        break;
