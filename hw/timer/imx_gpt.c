...
static const IMXClk imx53_gpt_clocks[] = {
    CLK_NONE,      /* 000 No clock */
    CLK_IPG,       /* 001 Peripheral Clock */
    CLK_IPG_HIGH,  /* 010 High Frequency Reference Clock */
    CLK_EXT,       /* 011 External Clock (IND_CLKIN) */
    CLK_32k,       /* 100 Low Frequency Reference Clock (32kHz) */
    CLK_HIGH,      /* 101 Crystal oscillator as Reference Clock (24MHz) */
    CLK_NONE,      /* 110 not defined */
    CLK_NONE,      /* 111 not defined */
};
...
static void imx53_gpt_init(Object *obj)
{
    IMXGPTState *s = IMX_GPT(obj);

    s->clocks = imx53_gpt_clocks;
}
...
static const TypeInfo imx53_gpt_info = {
    .name = TYPE_IMX53_GPT,
    .parent = TYPE_IMX25_GPT,
    .instance_init = imx53_gpt_init,
};
...
static void imx_gpt_register_types(void)
{
    ...
    type_register_static(&imx53_gpt_info);
