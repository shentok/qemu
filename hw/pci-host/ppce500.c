...
static void e500_pcihost_bridge_realize(PCIDevice *d, Error **errp)
{
    ...
    PlatformBusDevice *pbus = PLATFORM_BUS_DEVICE(container_get(qdev_get_machine(),
                                  "/e500-ccsr"));

    memory_region_init_alias(&b->bar0, OBJECT(pbus), "e500-pci-bar0", &pbus->mmio,
                             0, int128_get64(pbus->mmio.size));
