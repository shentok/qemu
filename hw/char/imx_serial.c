                                ...
                                unsigned size)
{
    ...
    trace_imx_serial_read(offset, value, chr ? chr->label : "NODEV");
                             ...
                             uint64_t value, unsigned size)
{
    ...
    trace_imx_serial_write(offset, value, chr ? chr->label : "NODEV");
...
static void imx_put_data(void *opaque, uint32_t value)
{
    ...
    trace_imx_serial_put_data(value, chr ? chr->label : "NODEV");
