...
static const char *m25p80_cmd_name(uint8_t cmd)
{
    switch (cmd) {
    case NOP: return "NOP";
...
static void complete_collecting_data(Flash *s)
{
    ...
    trace_m25p80_complete_collecting(s, s->cmd_in_progress,
                                     m25p80_cmd_name(s->cmd_in_progress), n,
                                     s->ear, s->cur_addr);
...
static void decode_new_cmd(Flash *s, uint32_t value)
{
    ...
    trace_m25p80_command_decoded(s, value, m25p80_cmd_name(value));
