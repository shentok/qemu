...
static void loongarch_devices_init(DeviceState *pch_pic, LoongArchMachineState *lams)
{
    ...
    memory_region_add_subregion(&ms->main_system_bus.memory.mr, VIRT_PCI_CFG_BASE,
                                ecam_alias);
    ...
    memory_region_add_subregion(&ms->main_system_bus.memory.mr, VIRT_PCI_MEM_BASE,
                                mmio_alias);
    ...
    memory_region_add_subregion(&ms->main_system_bus.memory.mr, VIRT_PCI_IO_BASE,
                                pio_alias);
    ...
    serial_mm_init(&ms->main_system_bus.memory.mr, VIRT_UART_BASE, 0,
    ...
    memory_region_add_subregion(&ms->main_system_bus.memory.mr, PM_BASE, pm_mem);
    /* acpi ged */
...
static void loongarch_irq_init(LoongArchMachineState *lams)
{
    ...
    sysbus_realize_and_unref(d, &error_fatal);
    memory_region_add_subregion(&ms->main_system_bus.memory.mr, VIRT_IOAPIC_REG_BASE,
...
static void loongarch_init(MachineState *machine)
{
    ...
    memory_region_add_subregion(&machine->main_system_bus.memory.mr, VIRT_FDT_BASE, fdt_rom);
