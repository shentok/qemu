                                                ...
                                                MemTxAttrs attrs)
{
    ...
    if (mr->subpage) {
        ...
        if (strcmp(memory_region_name(mr), "serial") != 0 && strcmp(memory_region_name(mr), "sdhci") != 0 && strcmp(memory_region_name(mr), "sparse-mem") != 0 && strcmp(memory_region_name(mr), "mpc-i2c") != 0) {
